        ...
        <table class="header-table">
            <tr>
                ...
                <td style="width: 20%; vertical-align: top;">
                    <img class="logo" src="<?php echo e(public_path('admin/images/logo.jpg')); ?>" style="height:80px; width:auto;">
                </td>
    ...
    <div class="signature-section">
        <div class="signature-box">
            ...
            <div class="signature-line">
                <?php echo e(($bonCommande->createdBy->name ?? '') . ' ' . ($bonCommande->createdBy->prenom ?? '')); ?><br>
        ...
        <div class="signature-box" style="float: right;">
            ...
            <div class="signature-line">
                <?php if($bonCommande->validated_at): ?>
                    <?php echo e(($bonCommande->validatedBy->name ?? '') . ' ' . ($bonCommande->validatedBy->prenom ?? '')); ?><br>
...
</html><?php /**PATH C:\Users\ADAM EDJABE\Desktop\cmcuapp\resources\views/admin/bon_commandes/pdf.blade.php ENDPATH**/ ?>