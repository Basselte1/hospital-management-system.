                            ...
                            <div class="table-responsive">
                                <table class="table table-hover mb-0">
                                    ...
                                    <tfoot class="bg-light">
                                        <tr class="fw-bold">
                                            <td colspan="<?php echo e(auth()->user()->role_id === 2 ? 2 : 3); ?>" class="text-end">TOTAUX :</td>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\JUSTO TCHEUMANI\DESKTOP\CMCU\Nouveaudossier\Deployfortest\cmcuapp\cmcuapp\resources\views/admin/patient_visits/patient_history.blade.php ENDPATH**/ ?>