...
<tr>
    ...
    <td><?php echo Html::input('text', 'specialite', old('specialite', $consultation_anesthesiste->specialite ?? ($assignedDoctor ? $assignedDoctor->specialite : '') ?? ''))->class('form-control')->required(); ?></td>
...
<tr>
    ...
    <td><?php echo Html::input('text', 'medecin_traitant', old('medecin_traitant', $consultation_anesthesiste->medecin_traitant ?? ($assignedDoctor ? $assignedDoctor->name . ' ' . ($assignedDoctor->prenom ?? '') : '')))->class('form-control')->required(); ?></td>
...
<tr>
    ...
    <td><?php echo Html::input('text', 'operateur', old('operateur', $consultation_anesthesiste->operateur ?? ($assignedDoctor ? $assignedDoctor->name . ' ' . ($assignedDoctor->prenom ?? '') : '')))->class('form-control')->required(); ?></td>
</tr>
<tr>
...
<?php echo Html::form()->close(); ?><?php /**PATH C:\Users\ADAM EDJABE\Desktop\cmcuapp\resources\views/admin/consultations/anesthesistes/form/consultation_anesthesiste_form.blade.php ENDPATH**/ ?>