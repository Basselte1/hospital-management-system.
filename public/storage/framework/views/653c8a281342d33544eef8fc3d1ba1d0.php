...
<div class="mid-class">
    <div class="art-contain-w3ls">
            ...
            <form action="<?php echo e(route('login')); ?>" method="post">
                ...
                <div class="form-footer">
                    <div class="left-side-forget">
                        <input type="checkbox" class="checked" name="remember" <?php echo e(old('remember') ? 'checked' : ''); ?>>
        ...
        <div class="art-left-w3ls">
            <img class="header-w3ls img" src="<?php echo e(asset('admin/images/logo.jpg')); ?>">
            <p class="text-center">
...
<?php echo $__env->make('layouts.login_layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\JUSTO TCHEUMANI\DESKTOP\CMCU\Nouveaudossier\Deployfortest\cmcuapp\cmcuapp\resources\views/auth/login.blade.php ENDPATH**/ ?>