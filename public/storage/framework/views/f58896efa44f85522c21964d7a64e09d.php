                ...
                <div class="card-body">
                    ...
                    <form class="mb-3" action="<?php echo e(route('users.update', $user->id)); ?>" method="POST">
                        ...
                        <div class="col-12">
                            ...
                            <div class="row g-3" id="otherFieldDiv" style="display: <?php echo e($user->role_id == 2 ? 'flex' : 'none'); ?>;">
                                <div class="col-md-6">
                                    ...
                                    <select name="specialite" class="form-select" id="specialite">
                                        ...
                                        <?php $__currentLoopData = \App\Models\User::getSpecialites(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($key); ?>" <?php echo e($user->specialite == $key ? 'selected' : ''); ?>>
                                                <?php echo e($label); ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input name="onmc" id="onmc" class="form-control" value="<?php echo e($user->onmc); ?>" type="text" placeholder="Numéro ONMC">
                                </div>
                            </div>

                            <!-- Optional: Show text input if "Autre" is selected -->
                            <div class="row g-3" id="autreSpecialiteDiv" style="display: <?php echo e($user->specialite == 'Autre' ? 'flex' : 'none'); ?>;">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="specialite_autre" class="form-control" id="specialite_autre" 
                                        value="<?php echo e($user->specialite == 'Autre' ? $user->specialite : ''); ?>" 
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\JUSTO TCHEUMANI\DESKTOP\CMCU\Nouveaudossier\Deployfortest\cmcuapp\cmcuapp\resources\views/admin/users/edit.blade.php ENDPATH**/ ?>