                ...
                <div class="tw-overflow-x-auto">
                    <table class="tw-w-full tw-text-sm">
                        ...
                        <tbody class="tw-divide-y tw-divide-slate-100">
                            <?php $__currentLoopData = $patient->consultationdesuivi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $suivi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:tw-bg-slate-50 tw-transition-colors">
                                <td class="tw-px-4 tw-py-3 tw-text-slate-700 tw-max-w-xs tw-truncate"><?php echo e($suivi->interrogatoire); ?></td>
                                <td class="tw-px-4 tw-py-3 tw-text-slate-600 tw-max-w-xs tw-truncate"><?php echo e($suivi->commentaire); ?></td>
                                <td class="tw-px-4 tw-py-3 tw-text-xs tw-text-slate-400 tw-whitespace-nowrap"><?php echo e($suivi->date_creation); ?></td>
                                <td class="tw-px-4 tw-py-3">
                                    <a href="<?php echo e(route('consultationsdesuivi.show', $suivi->id)); ?>" title="Voir"
...
</div><?php /**PATH C:\Users\ADAM EDJABE\Desktop\cmcuapp\resources\views/admin/modal/fichede_suivi.blade.php ENDPATH**/ ?>