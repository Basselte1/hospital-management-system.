                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select" name="motif" id="motif" >
                                        ...
                                        <div class="col-md-6">
                                            <label for="details_motif_consultation" id="label_details_motif" class="form-label fw-semibold">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cmcuapp\resources\views/admin/patient_visits/create.blade.php ENDPATH**/ ?>