            ...
            <div class="modal-body">
                ...
                <ul class="nav nav-tabs mb-3" id="medicalDocsTab" role="tablist">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('med_inf_anes', \App\Models\Patient::class)): ?>
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" type="button" ><a style="text-decoration:none;" href="<?php echo e(route('fiche.prescription_medicale.index', $patient)); ?>" title="Prescriptions médicales">
                                        ...
                                        <tbody id="ordonancesBody">
                                            <?php $__currentLoopData = $patient->ordonances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ordonance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php
                                                    ...
                                                    // Medication names legitimately contain commas
                                                    // (e.g. "Amoxicilline 500 mg, gélule").
                                                    // Legacy records without ' | ' are treated as
                                                    // a single item until re-saved in the edit form.
                                                ...
                                                <tr class="ordonance-row" 
                                                    ...
                                                    <td>
                                                        <?php $__currentLoopData = $meds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $med): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <div><?php echo e($med); ?></div>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </td>
                                                    <td>
                                                        <?php $__currentLoopData = $qtys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $qty): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <div><?php echo e($qty); ?></div>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </td>
                                                    <td>
                                                        <?php $__currentLoopData = $descs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $desc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <div><?php echo e($desc); ?></div>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </td>
                                                    <td><?php echo e($ordonance->created_at->toFormattedDateString()); ?></td>
                                                    <td>
                                                        <a class="btn btn-success btn-sm" title="Imprimer l'ordonance" href="<?php echo e(route('ordonance.pdf', $ordonance->id)); ?>">
                                                            <i class="fas fa-print"></i>
                                                        </a>

                                                        <a class="btn btn-primary btn-sm" title="Modifier l'ordonance"
                                                            href="<?php echo e(route('ordonances.edit', ['id' => $ordonance->id])); ?>?patient=<?php echo e($patient->id); ?>">
...
</script><?php /**PATH C:\Users\JUSTO TCHEUMANI\DESKTOP\CMCU\Nouveaudossier\Deployfortest\cmcuapp\cmcuapp\resources\views/admin/modal/ordonance_show.blade.php ENDPATH**/ ?>