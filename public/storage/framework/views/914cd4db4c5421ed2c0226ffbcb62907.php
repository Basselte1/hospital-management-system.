...
<head>
    <meta charset="utf-8">
    <title>Certificat de Stérilisation - <?php echo e($sterilization->numero_lot); ?></title>
    <style>
        @page {
            margin: 2cm;
        }
...
<body>
    ...
    <div class="certificate-info">
        <h2>N° Lot: <?php echo e($sterilization->numero_lot); ?></h2>
        <p style="margin: 5px 0;">
            <strong>Date d'émission:</strong> <?php echo e(now()->format('d/m/Y à H:i')); ?><br>
            <strong>Statut:</strong> 
            <span class="status-badge status-<?php echo e($sterilization->isRetourne() ? 'success' : 'danger'); ?>">
    ...
    <div class="section">
        ...
        <table>
            ...
            <tr>
                <th>Catégorie</th>
                <td><?php echo e($sterilization->produit->categorie); ?></td>
            </tr>
            <tr>
                <th>Quantité Stérilisée</th>
                <td><strong><?php echo e($sterilization->quantite); ?> unité(s)</strong></td>
            </tr>
        </table>
    </div>
    ...
    <div class="section">
        ...
        <div class="parameters-grid">
            <div class="param-row">
                ...
                <div class="param-value"><strong><?php echo e($sterilization->getMethodeLabel()); ?></strong></div>
            </div>
            <div class="param-row">
                <div class="param-label">Date de Stérilisation</div>
                <div class="param-value"><?php echo e($sterilization->date_sterilisation->format('d/m/Y')); ?></div>
            </div>
            <?php if($sterilization->heure_debut): ?>
            <div class="param-row">
                <div class="param-label">Heure de Début</div>
                <div class="param-value"><?php echo e($sterilization->heure_debut); ?></div>
            </div>
            <?php endif; ?>
            <?php if($sterilization->heure_fin): ?>
            <div class="param-row">
                <div class="param-label">Heure de Fin</div>
                <div class="param-value"><?php echo e($sterilization->heure_fin); ?></div>
            </div>
            <?php endif; ?>
            <?php if($sterilization->temperature): ?>
            <div class="param-row">
                <div class="param-label">Température</div>
                <div class="param-value"><strong><?php echo e($sterilization->temperature); ?>°C</strong></div>
            </div>
            <?php endif; ?>
            <?php if($sterilization->duree_minutes): ?>
            <div class="param-row">
                <div class="param-label">Durée</div>
                <div class="param-value"><strong><?php echo e($sterilization->duree_minutes); ?> minutes</strong></div>
            </div>
            <?php endif; ?>
            <?php if($sterilization->type_indicateur): ?>
            <div class="param-row">
                <div class="param-label">Indicateur Utilisé</div>
                <div class="param-value"><?php echo e($sterilization->type_indicateur); ?></div>
            </div>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="section">
        ...
        <div style="margin-top: 10px; padding: 10px; background: #f8f9fa; border-left: 3px solid #6c757d;">
            ...
            <?php echo e($sterilization->observations); ?>
    ...
    <div class="section">
        ...
        <table>
            ...
            <tr>
                ...
                <td><?php echo e($sterilization->retourne_at->format('d/m/Y à H:i')); ?></td>
            </tr>
            <?php endif; ?>
        </table>
    </div>
    ...
    <div class="section">
        ...
        <table>
            ...
            <tr>
                ...
                <td><?php echo e($sterilization->created_at->format('d/m/Y à H:i')); ?></td>
            </tr>
            <tr>
                <th>Référence Produit</th>
                <td>ID #<?php echo e($sterilization->produit->id); ?></td>
            </tr>
        </table>
    </div>
    ...
    <div class="signatures">
        <div class="signature-box">
            ...
            <div class="signature-line">
                <?php echo e($sterilization->sterilisePar->name); ?>

            </div>
            <small><?php echo e($sterilization->date_sterilisation->format('d/m/Y')); ?></small>
        </div>
        ...
        <div class="signature-box right">
            ...
            <div class="signature-line">
                <?php echo e($sterilization->verifiePar->name); ?>
    ...
    <div class="footer">
        ...
        Certificat généré le <?php echo e(now()->format('d/m/Y à H:i')); ?> | Document confidentiel
    </div>

</body>
</html><?php /**PATH C:\Users\JUSTO TCHEUMANI\DESKTOP\CMCU\Nouveaudossier\Deployfortest\cmcuapp\cmcuapp\resources\views/admin/reusable_products/certificate_pdf.blade.php ENDPATH**/ ?>