                    ...
                    <div class="col-md-10  toppad">
                        <div class="card">
                            <div class="card-body">
                                <table class="table">
                                    <tbody>
                                    <form action="<?php echo e(route('soins_infirmiers.store')); ?>" method="post">
                                        <?php echo csrf_field(); ?>
                                        <thead>
                                                <label for=""><b>Nom du patient: <?php echo e($patient->name); ?> <?php echo e($patient->prenom); ?></b></label> 
...
<?php /**PATH C:\Users\JUSTO TCHEUMANI\DESKTOP\CMCU\Nouveaudossier\Deployfortest\cmcuapp\cmcuapp\resources\views/admin/modal/soins_infirmier.blade.php ENDPATH**/ ?>