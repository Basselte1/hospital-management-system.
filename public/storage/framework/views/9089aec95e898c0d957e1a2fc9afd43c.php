...
<?php $__env->startSection('title', 'CMCU | Nouveau bon de laboratoire'); ?>
    ...
    <div id="content" class="tw-flex tw-flex-col tw-flex-1 tw-min-w-0 tw-overflow-y-auto">
        ...
        <main class="tw-flex-1 tw-p-4 sm:tw-p-6 lg:tw-p-8">
            ...
            <nav class="tw-flex tw-items-center tw-gap-2 tw-text-sm tw-text-slate-500 tw-mb-6">
                <a href="<?php echo e(route('laboratoire.index')); ?>" class="hover:tw-text-[#1D4ED8] tw-no-underline tw-transition-colors">Laboratoire</a>
            ...
            <div class="tw-flex tw-flex-col tw-items-center tw-gap-3 tw-py-16 tw-text-center">
                ...
                <a href="<?php echo e(route('laboratoire.index')); ?>" class="tw-text-[#1D4ED8] tw-text-sm tw-no-underline hover:tw-underline">← Retour</a>
            </div>
            <?php else: ?>
            ...
            <div class="tw-mb-4 tw-flex tw-items-center tw-gap-2 tw-bg-red-50 tw-border tw-border-red-200 tw-rounded-xl tw-px-4 tw-py-3">
                ...
                <p class="tw-text-sm tw-text-red-600 tw-mb-0"><?php echo e(session('error')); ?></p>
            </div>
            <?php endif; ?>
            ...
            <form method="POST" action="<?php echo e(route('laboratoire.store')); ?>" class="tw-max-w-4xl" id="bonForm">
                <?php echo csrf_field(); ?>
                        ...
                        <?php if(isset($patient) && $patient): ?>
                            ...
                            <div class="tw-flex tw-items-center tw-gap-3 tw-bg-teal-50 tw-border tw-border-teal-200 tw-rounded-xl tw-px-4 tw-py-3">
                                <div class="tw-w-10 tw-h-10 tw-rounded-full tw-bg-teal-200 tw-flex tw-items-center tw-justify-center tw-shrink-0">
                                    <span class="tw-text-teal-700 tw-font-bold tw-text-base"><?php echo e(strtoupper(substr($patient->prenom ?? $patient->name, 0, 1))); ?></span>
                                </div>
                                <div>
                                    <p class="tw-font-semibold tw-text-slate-800 tw-mb-0"><?php echo e($patient->prenom); ?> <?php echo e(strtoupper($patient->name)); ?></p>
                                    <p class="tw-text-xs tw-text-slate-500 tw-mb-0">N° dossier : <?php echo e($patient->numero_dossier); ?></p>
                                </div>
                                <a href="<?php echo e(route('laboratoire.create')); ?>" class="tw-ml-auto tw-text-xs tw-text-slate-400 hover:tw-text-[#1D4ED8] tw-no-underline">Changer</a>
                            </div>
                        <?php else: ?>
                            <?php
                            ...
                            <input type="hidden" id="patient_id" name="patient_id"
                                   value="<?php echo e(old('patient_id')); ?>" required>
...
$message = $__bag->first($__errorArgs[0]); ?>
                            <p class="tw-mt-1 tw-text-xs tw-text-red-500"><?php echo e($message); ?></p>
                            <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>

                            <script id="patientDataJson" type="application/json"><?php echo json_encode($patientJsonData, JSON_UNESCAPED_UNICODE | JSON_HEX_TAG | JSON_HEX_AMP); ?></script>
                        <?php endif; ?>
                    ...
                    <div class="tw-p-6 tw-grid tw-grid-cols-1 sm:tw-grid-cols-2 tw-gap-5">
                        <div>
                            ...
                            <select id="prescripteur_id" name="prescripteur_id"
                                ...
                                <option value="<?php echo e($m->id); ?>"
                                        data-nom="<?php echo e(strtolower($m->prenom . ' ' . $m->name)); ?>"
                                        <?php echo e(old('prescripteur_id') == $m->id ? 'selected' : ''); ?>>
                                    Dr <?php echo e($m->prenom); ?> <?php echo e($m->name); ?><?php echo e($m->specialite ? ' — ' . $m->specialite : ''); ?>
                        ...
                        <div>
                            ...
                            <input type="text" id="prescription_source" name="prescription_source"
                                   value="<?php echo e(old('prescription_source')); ?>"
                        ...
                        <div>
                            ...
                            <input type="date" id="date_prescription" name="date_prescription"
                                   value="<?php echo e(old('date_prescription', now()->toDateString())); ?>"
                        ...
                        <div>
                            ...
                            <input type="text" id="preparation_requise" name="preparation_requise"
                                   value="<?php echo e(old('preparation_requise')); ?>"
...
$message = $__bag->first($__errorArgs[0]); ?>
                    <div class="tw-mx-6 tw-mt-4 tw-flex tw-items-center tw-gap-2 tw-bg-red-50 tw-border tw-border-red-200 tw-rounded-xl tw-px-4 tw-py-2.5">
                        ...
                        <p class="tw-text-xs tw-text-red-600 tw-mb-0"><?php echo e($message); ?></p>
                    </div>
                    <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                    ...
                    <script id="laboTarifsJson" type="application/json"><?php echo json_encode($tarifsBySection, JSON_UNESCAPED_UNICODE | JSON_HEX_TAG); ?></script>

                    
                    <div class="tw-p-6" id="laboSectionsGrid">

                        <?php if($sectionObjects->isEmpty()): ?>
                            <div class="tw-flex tw-flex-col tw-items-center tw-gap-3 tw-py-10 tw-text-center">
                                ...
                                <a href="<?php echo e(route('sections_labo.create')); ?>"
                        ...
                        <?php else: ?>
                            <?php $__currentLoopData = $sectionObjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sectionKey => $sectionObj): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            <div class="tw-border tw-rounded-xl tw-overflow-hidden tw-mb-4 <?php echo e($sectionObj->color_classes); ?>"
                                 data-section-panel="<?php echo e($sectionKey); ?>">
                                ...
                                <div class="tw-flex tw-items-center tw-gap-3 tw-px-4 tw-py-3 tw-cursor-pointer tw-bg-white/60 hover:tw-bg-white tw-transition-colors tw-select-none section-header"
                                     onclick="toggleSectionPanel('<?php echo e($sectionKey); ?>', this)">

                                    <input type="checkbox"
                                           id="master_<?php echo e($sectionKey); ?>"
                                           class="section-master-cb tw-w-4 tw-h-4 tw-rounded tw-border-slate-300 tw-cursor-pointer"
                                           data-section="<?php echo e($sectionKey); ?>"
                                           onclick="event.stopPropagation(); masterToggle('<?php echo e($sectionKey); ?>', this.checked)"
                                           <?php echo e($hasPrescribed ? 'checked' : ''); ?>>

                                    <i class="fas <?php echo e($sectionObj->icon); ?> tw-text-sm tw-text-slate-500 tw-w-4 tw-text-center"></i>

                                    
                                    <span class="tw-text-sm tw-font-semibold tw-text-slate-700 tw-flex-1">
                                        <?php echo e($sectionObj->label); ?>

                                    </span>

                                    <span id="subtotal_<?php echo e($sectionKey); ?>" class="tw-text-xs tw-font-mono tw-text-slate-500 tw-mr-2">—</span>

                                    <i class="fas fa-chevron-down tw-text-xs tw-text-slate-400 section-chevron tw-transition-transform tw-duration-200
                                        <?php echo e($hasPrescribed ? '' : 'tw-rotate-[-90deg]'); ?>"
                                       id="chevron_<?php echo e($sectionKey); ?>"></i>
                                </div>

                                
                                <div id="panel_<?php echo e($sectionKey); ?>"
                                     class="tw-border-t tw-border-slate-100 <?php echo e($hasPrescribed ? '' : 'tw-hidden'); ?>">

                                    <?php if($hasTests): ?>
                                        <div class="tw-p-4 tw-grid tw-grid-cols-2 sm:tw-grid-cols-3 md:tw-grid-cols-4 lg:tw-grid-cols-6 tw-gap-3">
                                            <?php $__currentLoopData = $sectionTarifs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testName => $prix): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                            ...
                                            <div class="tw-relative tw-bg-white tw-border tw-border-slate-200 tw-rounded-xl tw-p-3 tw-shadow-sm hover:tw-shadow-md tw-transition-shadow
                                                        <?php echo e($isDone ? 'tw-opacity-60 tw-bg-slate-50' : ''); ?>">
                                                <label class="tw-flex tw-flex-col tw-gap-1 tw-cursor-pointer">
                                                    <div class="tw-flex tw-items-start tw-gap-2">
                                                        <input type="checkbox"
                                                               name="tests[<?php echo e($sectionKey); ?>][]"
                                                               value="<?php echo e($testName); ?>"
                                                               class="test-checkbox tw-w-4 tw-h-4 tw-rounded tw-border-slate-300 tw-mt-0.5 tw-shrink-0"
                                                               data-section="<?php echo e($sectionKey); ?>"
                                                               data-price="<?php echo e($prix); ?>"
                                                               <?php echo e($isPrescribed && !$isDone ? 'checked' : ''); ?>

                                                               onchange="recalcTotal()"
                                                               <?php echo e($isDone ? 'disabled' : ''); ?>>
                                                        <span class="tw-text-sm tw-font-medium tw-text-slate-700 tw-break-words"><?php echo e($testName); ?></span>
                                                    </div>
                                                    <div class="tw-text-right tw-text-xs tw-font-mono tw-text-green-600 tw-mt-1">
                                                        <?php echo e(number_format($prix, 0, ',', ' ')); ?> FCFA
                                                    </div>
                                                    <?php if($isDone): ?>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <div class="tw-px-5 tw-py-4 tw-flex tw-items-center tw-justify-between">
                                            ...
                                            <?php if(auth()->user()->role_id === 1): ?>
                                            <a href="<?php echo e(route('tarifs_labo.create')); ?>"
                    ...
                    <div class="tw-p-6 tw-grid tw-grid-cols-1 sm:tw-grid-cols-3 tw-gap-5">
                        <div>
                            ...
                            <input type="number" id="montant_paye" name="montant_paye"
                                   value="<?php echo e(old('montant_paye', 0)); ?>" min="0" step="100"
                                   class="tw-block tw-w-full tw-px-4 tw-py-2.5 tw-text-sm tw-border tw-border-slate-200 tw-rounded-xl focus:tw-outline-none focus:tw-border-[#1D4ED8]">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select id="mode_paiement" name="mode_paiement"
                                    class="tw-block tw-w-full tw-px-4 tw-py-2.5 tw-text-sm tw-border tw-border-slate-200 tw-rounded-xl tw-bg-white focus:tw-outline-none focus:tw-border-[#1D4ED8]">
                                <?php $__currentLoopData = ['espèces' => 'Espèces', 'mobile_money' => 'Mobile Money', 'carte' => 'Carte bancaire', 'cheque' => 'Chèque', 'virement' => 'Virement', 'assurance' => 'Assurance']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $lbl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($val); ?>" <?php echo e(old('mode_paiement', 'espèces') === $val ? 'selected' : ''); ?>><?php echo e($lbl); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ADAM EDJABE\Desktop\cmcuapp\resources\views/admin/laboratoire/create.blade.php ENDPATH**/ ?>