                ...
                <div class="col-12">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <!--p class="text-muted mb-0">Traçabilité complète de toutes les visites</p-->
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex flex-column">
                                                    <span class="fw-semibold"><?php echo e($visit->patient->name); ?> <?php echo e($visit->patient->prenom); ?></span>
                                                    <small class="text-muted">CMCU-<?php echo e($visit->patient->numero_dossier); ?></small>
                                                </div>
                                            </td>
                                            <td>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\JUSTO TCHEUMANI\DESKTOP\CMCU\Nouveaudossier\Proj\cmcu\cmcuapp\resources\views/admin/patient_visits/index.blade.php ENDPATH**/ ?>