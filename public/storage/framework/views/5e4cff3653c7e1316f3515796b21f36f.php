    ...
    <table width="100%" style="border-collapse: collapse; margin-bottom: 12px;">
        <tr>
            <td style="vertical-align: top; width: 50%;">
                <small><b>CHIRURGIEN :</b> Dr. <?php echo e($crbo->chirurgien ?? 'N/A'); ?></small><br>
                <small><b>AIDE OPÉRATOIRE :</b> Dr. <?php echo e($crbo->aide_op ?? 'N/A'); ?></small><br>
                <small><b>ANESTHÉSISTE :</b> Dr. <?php echo e($crbo->anesthesiste ?? 'N/A'); ?></small><br>
                <small><b>INFIRMIER ANESTHÉSISTE :</b> <?php echo e($crbo->infirmier_anesthesiste ?? 'N/A'); ?></small>
            </td>
            <td style="vertical-align: top; text-align: right; width: 50%;">
                <small><b>DATE D'ENTRÉE :</b> <?php echo e($crbo->date_e ?? 'N/A'); ?></small><br>
                <small><b>TYPE D'ENTRÉE :</b> <?php echo e($crbo->type_e ?? 'N/A'); ?></small><br>
                <small><b>DATE DE SORTIE :</b> <?php echo e($crbo->date_s ?? 'N/A'); ?></small><br>
                <small><b>TYPE DE SORTIE :</b> <?php echo e($crbo->type_s ?? 'N/A'); ?></small>
            </td>
        </tr>
    </table>

    <p><u><b>TYPE D'INTERVENTION :</b></u></p>
    <p><b><?php echo nl2br(e($consultation->type_intervention ?? 'N/A')); ?></b></p>
    <br>

    <p><u><b>DATE D'INTERVENTION :</b></u> <?php echo e($crbo->date_intervention ?? 'N/A'); ?></p>
    <br>

    <p><u><b>INDICATIONS OPÉRATOIRES :</b></u></p>
    <p><?php echo nl2br(e($crbo->indication_operatoire ?? '')); ?></p>
    <br>

    <p><u><b>COMPTE-RENDU OPÉRATOIRE :</b></u></p>
    <p><?php echo nl2br(e($crbo->compte_rendu_o ?? '')); ?></p>
    <br>

    <p><u><b>SUITES OPÉRATOIRES :</b></u></p>
    <p><?php echo nl2br(e($crbo->suite_operatoire ?? '')); ?></p>
    <br>

    <p><u><b>CONCLUSIONS :</b></u></p>
    <p><?php echo nl2br(e($crbo->conclusion ?? '')); ?></p>
    <br>

    <p><u><b>PROPOSITION DE SUIVI :</b></u></p>
    <p><?php echo nl2br(e($crbo->proposition_suivi ?? '')); ?></p>
    <br>

    <div style="text-align: right; margin-top: 30px;">
        <p><b>Dr <?php echo e(auth()->user()->name ?? ''); ?></b></p>
    </div>
...
</div><?php /**PATH C:\Users\ADAM EDJABE\Desktop\cmcuapp\resources\views/admin/etats/crbo.blade.php ENDPATH**/ ?>