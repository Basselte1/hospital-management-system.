                            ...
                            <div class="tw-mb-8">
                                ...
                                <div class="tw-grid tw-grid-cols-1 sm:tw-grid-cols-2 tw-gap-4">
                                    ...
                                    <div class="sm:tw-col-span-2">
                                        ...
                                        <?php $__errorArgs = ['assigne_a'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                            <p class="tw-text-red-500 tw-text-xs tw-mt-1"><?php echo e($message); ?></p>
                                        <?php unset($message);
                                ...
                                <div class="tw-grid tw-grid-cols-1 sm:tw-grid-cols-2 tw-gap-4">
                                    ...
                                    <div>
                                        ...
                                        <select class="motif-field tw-w-full tw-rounded-xl tw-border tw-border-slate-200 tw-bg-slate-50 tw-px-4 tw-py-2.5 tw-text-sm tw-text-slate-700 focus:tw-outline-none focus:tw-bg-white focus:tw-ring-2 focus:tw-ring-[#BFDBFE] focus:tw-border-[#1D4ED8] tw-transition-all"
                                            ...
                                            <option value="Consultation générale"    <?php echo e(old('details_motif_consultation') == 'Consultation générale'    ? 'selected' : ''); ?>>Consultation générale</option>
                                            <option value="Consultation anesthesique" <?php echo e(old('details_motif_consultation') == 'Consultation anesthesique' ? 'selected' : ''); ?>>Consultation anesthesique</option>
                                            <option value="Consultation de suivi"    <?php echo e(old('details_motif_consultation') == 'Consultation de suivi'    ? 'selected' : ''); ?>>Consultation de suivi</option>
                                        </select>
                                        ...
                                        <select class="motif-field tw-w-full tw-rounded-xl tw-border tw-border-slate-200 tw-bg-slate-50 tw-px-4 tw-py-2.5 tw-text-sm tw-text-slate-700 focus:tw-outline-none focus:tw-bg-white focus:tw-ring-2 focus:tw-ring-[#BFDBFE] focus:tw-border-[#1D4ED8] tw-transition-all"
                                            ...
                                            <optgroup label="Actes Urologiques">
                                                <option value="Cystoscopie"         <?php echo e(old('details_motif_acte') == 'Cystoscopie'         ? 'selected' : ''); ?>>Cystoscopie</option>
                                                <option value="Biopsie prostatique" <?php echo e(old('details_motif_acte') == 'Biopsie prostatique' ? 'selected' : ''); ?>>Biopsie prostatique</option>
                                                <option value="Circoncision"        <?php echo e(old('details_motif_acte') == 'Circoncision'        ? 'selected' : ''); ?>>Circoncision</option>
                                                <option value="Vasectomie"          <?php echo e(old('details_motif_acte') == 'Vasectomie'          ? 'selected' : ''); ?>>Vasectomie</option>
                                                <option value="Lithotripsie"        <?php echo e(old('details_motif_acte') == 'Lithotripsie'        ? 'selected' : ''); ?>>Lithotripsie</option>
                                                <option value="Urétéroscopie"       <?php echo e(old('details_motif_acte') == 'Urétéroscopie'       ? 'selected' : ''); ?>>Urétéroscopie</option>
                                                <option value="Néphrectomie"        <?php echo e(old('details_motif_acte') == 'Néphrectomie'        ? 'selected' : ''); ?>>Néphrectomie</option>
                                                <option value="Prostatectomie"      <?php echo e(old('details_motif_acte') == 'Prostatectomie'      ? 'selected' : ''); ?>>Prostatectomie</option>
                                                <option value="Cure d'hydrocèle"    <?php echo e(old('details_motif_acte') == "Cure d'hydrocèle"    ? 'selected' : ''); ?>>Cure d'hydrocèle</option>
                                                <option value="Pose de sonde JJ"    <?php echo e(old('details_motif_acte') == 'Pose de sonde JJ'    ? 'selected' : ''); ?>>Pose de sonde JJ</option>
                                            </optgroup>
                                            <optgroup label="Actes Chirurgicaux Généraux">
                                                <option value="Laparotomie exploratrice" <?php echo e(old('details_motif_acte') == 'Laparotomie exploratrice' ? 'selected' : ''); ?>>Laparotomie exploratrice</option>
                                                <option value="Appendicectomie"          <?php echo e(old('details_motif_acte') == 'Appendicectomie'          ? 'selected' : ''); ?>>Appendicectomie</option>
                                                <option value="Cholécystectomie"         <?php echo e(old('details_motif_acte') == 'Cholécystectomie'         ? 'selected' : ''); ?>>Cholécystectomie</option>
                                                <option value="Hernioplastie"            <?php echo e(old('details_motif_acte') == 'Hernioplastie'            ? 'selected' : ''); ?>>Hernioplastie</option>
                                                <option value="Cure de varicocèle"       <?php echo e(old('details_motif_acte') == 'Cure de varicocèle'       ? 'selected' : ''); ?>>Cure de varicocèle</option>
                                            </optgroup>
                                            <optgroup label="Actes Endoscopiques">
                                                <option value="Endoscopie digestive" <?php echo e(old('details_motif_acte') == 'Endoscopie digestive' ? 'selected' : ''); ?>>Endoscopie digestive</option>
                                                <option value="Coloscopie"           <?php echo e(old('details_motif_acte') == 'Coloscopie'           ? 'selected' : ''); ?>>Coloscopie</option>
                                                <option value="Gastroscopie"         <?php echo e(old('details_motif_acte') == 'Gastroscopie'         ? 'selected' : ''); ?>>Gastroscopie</option>
                                            </optgroup>
                                            <option value="Autre acte" <?php echo e(old('details_motif_acte') == 'Autre acte' ? 'selected' : ''); ?>>Autre acte (à préciser)</option>
                                        </select>
                                        ...
                                        <input type="text"
                                               ...
                                               value="<?php echo e(old('details_motif_autres')); ?>"
                                               style="display:none;">
                                    ...
                                    <div>
                                        ...
                                        <input type="date" name="date_insertion" id="date_insertion"
                                               value="<?php echo e(old('date_insertion', date('Y-m-d'))); ?>"
                                               readonly required
                                    ...
                                    <div>
                                        ...
                                        <select name="mode_paiement" id="mode_paiement"
                                            ...
                                            <optgroup label="Autres moyens">
                                                <option value="espèce" <?php echo e(old('mode_paiement', 'espèce') == 'espèce' ? 'selected' : ''); ?>>Espèce</option>
                                    ...
                                    <div>
                                        ...
                                        <div class="tw-flex tw-rounded-xl tw-overflow-hidden tw-border tw-border-slate-200 focus-within:tw-ring-2 focus-within:tw-ring-[#BFDBFE] focus-within:tw-border-[#1D4ED8] tw-transition-all">
                                            <input name="montant" id="montant"
                                                   value="<?php echo e(old('montant', 0)); ?>" type="number" min="0" step="1" required
                                                ...
                                                <div>
                                                    ...
                                                    <div class="tw-flex tw-rounded-xl tw-overflow-hidden tw-border tw-border-slate-200 focus-within:tw-ring-2 focus-within:tw-ring-[#BFDBFE] focus-within:tw-border-[#1D4ED8] tw-transition-all">
                                                        <input name="taux_conversion" id="taux_conversion"
                                                               value="<?php echo e(old('taux_conversion')); ?>" type="number"
                                                ...
                                                <div>
                                                    ...
                                                    <div class="tw-flex tw-rounded-xl tw-overflow-hidden tw-border tw-border-slate-200 focus-within:tw-ring-2 focus-within:tw-ring-[#BFDBFE] focus-within:tw-border-[#1D4ED8] tw-transition-all">
                                                        <input name="montant_devise" id="montant_devise"
                                                               value="<?php echo e(old('montant_devise')); ?>" type="number"
                                    ...
                                    <div>
                                        ...
                                        <div class="tw-flex tw-rounded-xl tw-overflow-hidden tw-border tw-border-slate-200 focus-within:tw-ring-2 focus-within:tw-ring-[#BFDBFE] focus-within:tw-border-[#1D4ED8] tw-transition-all">
                                            <input name="avance" id="avance"
                                                   value="<?php echo e(old('avance', 0)); ?>" type="number" min="0" step="1" required
                                                   class="tw-flex-1 tw-rounded-l-xl tw-border-0 tw-bg-slate-50 tw-px-4 tw-py-2.5 tw-text-sm tw-text-slate-700 focus:tw-outline-none focus:tw-bg-white tw-transition-all">
                                            <span class="tw-bg-[#1D4ED8] tw-px-4 tw-flex tw-items-center tw-text-white tw-text-sm tw-rounded-r-xl">FCFA</span>
                                        </div>
                                            ...
                                            <div class="tw-grid tw-grid-cols-1 sm:tw-grid-cols-3 tw-gap-3">
                                                <div>
                                                    ...
                                                    <input name="num_cheque" id="num_cheque" type="text"
                                                           value="<?php echo e(old('num_cheque')); ?>" placeholder="N° du chèque"
                                                ...
                                                <div>
                                                    ...
                                                    <input name="emetteur_cheque" id="emetteur_cheque" type="text"
                                                           value="<?php echo e(old('emetteur_cheque')); ?>" placeholder="Nom de l'émetteur"
                                                           class="tw-w-full tw-rounded-lg tw-border tw-border-slate-200 tw-bg-white tw-px-3 tw-py-2 tw-text-sm tw-text-slate-700 focus:tw-outline-none focus:tw-ring-2 focus:tw-ring-[#BFDBFE] focus:tw-border-[#1D4ED8] tw-transition-all">
                                                </div>
                                                <div>
                                                    ...
                                                    <input name="banque_cheque" id="banque_cheque" type="text"
                                                           value="<?php echo e(old('banque_cheque')); ?>" placeholder="Nom de la banque"
                                                           class="tw-w-full tw-rounded-lg tw-border tw-border-slate-200 tw-bg-white tw-px-3 tw-py-2 tw-text-sm tw-text-slate-700 focus:tw-outline-none focus:tw-ring-2 focus:tw-ring-[#BFDBFE] focus:tw-border-[#1D4ED8] tw-transition-all">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tw-rounded-xl tw-bg-slate-50 tw-border tw-border-slate-200 tw-p-4">
                                            ...
                                            <div>
                                                ...
                                                <input name="emetteur_bpc" id="emetteur_bpc" type="text"
                                                       value="<?php echo e(old('emetteur_bpc')); ?>" placeholder="Nom de l'organisme émetteur"
                                                       class="tw-w-full tw-rounded-lg tw-border tw-border-slate-200 tw-bg-white tw-px-3 tw-py-2 tw-text-sm tw-text-slate-700 focus:tw-outline-none focus:tw-ring-2 focus:tw-ring-[#BFDBFE] focus:tw-border-[#1D4ED8] tw-transition-all">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="tw-grid tw-grid-cols-1 sm:tw-grid-cols-2 tw-gap-4">
                                    <div>
                                        ...
                                        <input name="assurance" id="assurance" type="text"
                                               value="<?php echo e(old('assurance')); ?>"
                                    ...
                                    <div>
                                        ...
                                        <input name="numero_assurance" id="numero_assurance" type="text"
                                               value="<?php echo e(old('numero_assurance')); ?>"
                                    ...
                                    <div class="sm:tw-col-span-2">
                                        ...
                                        <div class="tw-flex tw-rounded-xl tw-overflow-hidden tw-border tw-border-slate-200 focus-within:tw-ring-2 focus-within:tw-ring-[#BFDBFE] focus-within:tw-border-[#1D4ED8] tw-transition-all">
                                            <select name="prise_en_charge" id="prise_en_charge" required
                                                ...
                                                <option <?php echo e(old('prise_en_charge', 0) == $taux ? 'selected' : ''); ?>><?php echo e($taux); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    <?php if(old('motif')): ?>
        handleMotifChange();
        <?php if(old('motif') === 'Examen' && old('details_motif')): ?>
            // Ré-afficher la valeur des examens dans la zone lecture seule
            examenDisplayText.textContent = '<?php echo e(old('details_motif')); ?>';
        <?php endif; ?>
        syncDetailsMotif();
    <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ADAM EDJABE\Desktop\cmcuapp\resources\views/admin/patients/create.blade.php ENDPATH**/ ?>