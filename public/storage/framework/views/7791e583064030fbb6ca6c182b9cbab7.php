...
<?php $__env->startSection('title', 'Facturation - Actes'); ?>
...
<div class="container-fluid">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <a href="<?php echo e(route('facturation.actes.index')); ?>" class="btn btn-secondary">Reset</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo e(route('facturation.actes.show', $facture)); ?>" class="btn btn-sm btn-info">Voir</a>
                                <a href="<?php echo e(route('facturation.actes.print', $facture)); ?>" class="btn btn-sm btn-success">Imprimer</a>
                            </td>
                        </tr>
    ...
    <div class="text-end mt-3">
        <a href="<?php echo e(route('facturation.actes.create')); ?>" class="btn btn-success">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ADAM EDJABE\Desktop\cmcuapp\resources\views/facturation/actes/index.blade.php ENDPATH**/ ?>