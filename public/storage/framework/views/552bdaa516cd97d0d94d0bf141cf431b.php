        ...
        <div class="modal-content tw-rounded-2xl tw-border-0 tw-shadow-xl tw-overflow-hidden">
            <div class="tw-flex tw-items-center tw-justify-between tw-px-6 tw-py-4 tw-bg-[#1e40af]">
                <h5 class="tw-text-white tw-font-semibold tw-mb-0 tw-text-sm tw-uppercase tw-tracking-wide">
                    <i class="fas fa-heartbeat tw-mr-2"></i>Surveillance Post Anesthésique — <?php echo e($patient->name); ?> <?php echo e($patient->prenom); ?>

                </h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="tw-p-6">
                <form action="<?php echo e(route('surveillance_post_anesthesise.store')); ?>" method="post" class="tw-space-y-4">
                    <?php echo csrf_field(); ?>
                    ...
                    <div>
                        <label class="tw-block tw-text-xs tw-font-medium tw-text-slate-600 tw-mb-1.5">
                            <?php echo e($field['label']); ?> <?php if($field['required']): ?><span class="tw-text-red-500">*</span><?php endif; ?>
                        </label>
...
</div><?php /**PATH C:\Users\ADAM EDJABE\Desktop\cmcuapp\resources\views/admin/modal/surveillance_post_a.blade.php ENDPATH**/ ?>