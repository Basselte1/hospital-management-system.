    ...
    <div class="tw-px-5 tw-py-3.5 tw-bg-[#14B8A6] tw-flex tw-items-center tw-justify-between tw-cursor-pointer"
        ...
        <div class="tw-flex tw-items-center tw-gap-2.5">
            ...
            <span class="tw-inline-flex tw-items-center tw-rounded-full tw-bg-white tw-text-teal-600 tw-px-2 tw-py-0.5 tw-text-xs tw-font-bold">
                <?php echo e($patient->visits()->count()); ?>
    ...
    <div class="collapse show" id="historiqueVisites">
        <div class="tw-p-4">
                        ...
                        <tr class="hover:tw-bg-slate-50 tw-transition-colors">
                            <td class="tw-px-3 tw-py-2.5 tw-whitespace-nowrap">
                                <span class="tw-font-semibold tw-text-slate-700 tw-text-xs">
                                    <?php echo e($visit->visit_date->format('d/m/Y')); ?>
                            ...
                            <td class="tw-px-3 tw-py-2.5 tw-text-right tw-text-xs tw-text-slate-600 tw-whitespace-nowrap">
                                <?php echo e(number_format($visit->montant)); ?> F
                            </td>
                            <td class="tw-px-3 tw-py-2.5 tw-text-right tw-text-xs tw-font-semibold tw-whitespace-nowrap <?php echo e($visit->reste > 0 ? 'tw-text-red-500' : 'tw-text-teal-600'); ?>">
                                <?php echo e(number_format($visit->reste)); ?> F
                            </td>
                            <?php endif; ?>
                            <td class="tw-px-3 tw-py-2.5 tw-text-center">
                                <span class="tw-inline-flex tw-items-center tw-rounded-full tw-px-2.5 tw-py-0.5 tw-text-[10px] tw-font-semibold tw-bg-<?php echo e($visit->status_badge_color); ?>-100 tw-text-<?php echo e($visit->status_badge_color); ?>-700">
                                    <?php echo e($visit->status_label); ?>

                                </span>
                            </td>
                            <td class="tw-px-3 tw-py-2.5 tw-text-center">
                                <a href="<?php echo e(route('patient-visits.patient-history', $visit->patient)); ?>"
            ...
            <div class="tw-mt-3 tw-text-center">
                <a href="<?php echo e(route('patient-visits.patient-history', $patient)); ?>"
            ...
            <div class="tw-mt-4 tw-pt-4 tw-border-t tw-border-slate-100 tw-grid tw-grid-cols-3 tw-gap-3">
                <div class="tw-text-center">
                    ...
                    <p class="tw-font-bold tw-text-teal-600 tw-text-sm tw-mb-0">
                        <?php echo e(number_format($patient->visits()->sum('montant'))); ?> F
                    </p>
                </div>
                <div class="tw-text-center tw-border-x tw-border-slate-100">
                    ...
                    <p class="tw-font-bold tw-text-[#1D4ED8] tw-text-sm tw-mb-0">
                        <?php echo e(number_format($patient->visits()->sum('avance'))); ?> F
                    </p>
                </div>
                <div class="tw-text-center">
                    <p class="tw-text-[10px] tw-text-slate-400 tw-mb-1 tw-uppercase tw-tracking-wide">Reste à payer</p>
                    <p class="tw-font-bold tw-text-sm tw-mb-0 <?php echo e($patient->visits()->sum('reste') > 0 ? 'tw-text-red-500' : 'tw-text-teal-600'); ?>">
            ...
            <div class="tw-py-8 tw-text-center">
                ...
                <a href="<?php echo e(route('patient-visits.create')); ?>?patient_id=<?php echo e($patient->id); ?>"
...
</script><?php /**PATH C:\Users\ADAM EDJABE\Desktop\cmcuapp\resources\views/admin/patients/patient_visits_widget.blade.php ENDPATH**/ ?>