...
<?php $__env->startSection('title', $title ?? 'Aperçu Document'); ?> 
...
/* Allow the editor page to scroll freely */
body,
.wrapper,
#content {
    ...
    <div class="editor-wrapper" style="overflow-y: auto;">
        ...
        <div class="editor-header">
            ...
            <div class="header-actions">
                ...
                <a href="<?php echo e(url()->previous()); ?>" class="btn-action btn-light btn-sm">
...
<script src="<?php echo e(asset('build/ckeditor/ckeditor.js')); ?>"></script>
...
async function saveDocument(silent = false) {
    ...
    try {
        ...
        const response = await fetch('<?php echo e(route("print.preview.save", ["type" => $type, "id" => $id])); ?>', {
            method: 'POST',
            headers: {
...
async function printDocument() {
    ...
    try {
        const url = '<?php echo e(route("print.preview.print", ["type" => $type, "id" => $id])); ?>?delivery=print';
...
async function downloadPdf() {
    ...
    try {
        const url = '<?php echo e(route("print.preview.print", ["type" => $type, "id" => $id])); ?>?delivery=download';
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\JUSTO TCHEUMANI\DESKTOP\CMCU\Nouveaudossier\Deployfortest\cmcuapp\cmcuapp\resources\views/admin/print-preview/editor.blade.php ENDPATH**/ ?>