...
<div class="container">
    ...
    <?php $__currentLoopData = [
        ...
        <?php if($prescription->$field): ?>
            <div class="exam-block">
                <h5><?php echo e($label); ?></h5>
                <ul class="exam-list">
                    <?php $__currentLoopData = (array) $prescription->$field; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
</div><?php /**PATH C:\Users\ADAM EDJABE\Desktop\cmcuapp\resources\views/admin/etats/prescriptions.blade.php ENDPATH**/ ?>