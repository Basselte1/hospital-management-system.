<div class="modal fade" id="VisiteAnesthesiste" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content tw-rounded-2xl tw-border-0 tw-shadow-xl tw-overflow-hidden">
            ...
            <div class="tw-p-6">
                <form action="<?php echo e(route('visite_preanesthesique.store')); ?>" method="post" class="tw-space-y-4">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="tw-rounded-xl tw-bg-[#BFDBFE]/20 tw-border tw-border-[#BFDBFE] tw-p-4">
                        ...
                        <div class="tw-grid tw-grid-cols-1 sm:tw-grid-cols-2 tw-gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" value="<?php echo e($patient->name); ?>" name="nom_patient" disabled
                            ...
                            <div>
                                ...
                                <input type="text" value="<?php echo e($patient->prenom); ?>" name="prenom_patient" disabled
                                       class="tw-w-full tw-rounded-xl tw-border tw-border-slate-200 tw-bg-slate-100 tw-px-3 tw-py-2 tw-text-sm tw-text-slate-500">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" value="<?php echo e($dossier->sexe); ?>" name="sexe_patient" disabled
                                       class="tw-w-full tw-rounded-xl tw-border tw-border-slate-200 tw-bg-slate-100 tw-px-3 tw-py-2 tw-text-sm tw-text-slate-500">
                            </div>
                    ...
                    <div>
                        ...
                        <textarea name="element_nouveaux" id="vpa" rows="8" required
                                  class="tw-w-full tw-rounded-xl tw-border tw-border-slate-200 tw-bg-slate-50 tw-px-3 tw-py-2 tw-text-sm focus:tw-outline-none focus:tw-ring-2 focus:tw-ring-[#BFDBFE] tw-resize-none"><?php echo e(old('element_nouveaux')); ?></textarea>
                    </div>
...
</div><?php /**PATH C:\Users\ADAM EDJABE\Desktop\cmcuapp\resources\views/admin/modal/visite_preanesthesique.blade.php ENDPATH**/ ?>