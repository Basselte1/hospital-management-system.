                            ...
                            <table class="tw-w-full tw-text-sm">
                                <tbody class="tw-divide-y tw-divide-slate-100">
                                    ...
                                    <tr class="hover:tw-bg-slate-50/50">
                                        ...
                                        <?php if($item): ?>
                                        <td class="tw-px-4 tw-py-2.5 tw-text-slate-600 tw-w-[40%]"><?php echo e($item); ?></td>
...
</div><?php /**PATH C:\Users\ADAM EDJABE\Desktop\cmcuapp\resources\views/admin/modal/fiche_intervention.blade.php ENDPATH**/ ?>