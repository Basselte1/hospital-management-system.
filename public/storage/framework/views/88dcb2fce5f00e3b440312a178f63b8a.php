...
<?php $__env->startSection('title', 'CMCU | Liste des produits matériels'); ?>
    ...
    <div class="container-fluid py-4">
        ...
        <div class="row mb-4">
            <div class="col text-center">
                <h1 class="fw-bold text-primary"> Liste des Produits Matériels</h1>
            ...
            <div class="col-md-3">
                <div class="card shadow-sm border-0 bg-danger text-white text-center">
                    <div class="card-body">
                        ...
                        <h2 class="fw-bold"><?php echo e($materielCount); ?></h2>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\JUSTO TCHEUMANI\DESKTOP\CMCU\Nouveaudossier\Proj\cmcu\cmcuapp\resources\views/admin/produits/materiel.blade.php ENDPATH**/ ?>