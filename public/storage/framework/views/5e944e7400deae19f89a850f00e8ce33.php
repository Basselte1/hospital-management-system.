...
<?php $__env->startSection('title', 'CMCU | Liste des rôles'); ?>
            ...
            <div class="tw-bg-white tw-rounded-2xl tw-shadow-sm tw-border tw-border-slate-100 tw-overflow-hidden">
                ...
                <div class="tw-px-6 tw-py-4 tw-border-b tw-border-slate-100 tw-flex tw-items-center tw-gap-2">
                    ...
                    <span class="tw-ml-auto tw-inline-flex tw-items-center tw-px-2.5 tw-py-0.5 tw-rounded-full tw-text-xs tw-font-medium tw-bg-[#BFDBFE] tw-text-[#1D4ED8]">
                        <?php echo e(count($roles)); ?> rôle<?php echo e(count($roles) > 1 ? 's' : ''); ?>
                    ...
                    <table id="myTable" class="tw-w-full tw-text-sm tw-text-left">
                        ...
                        <tbody class="tw-divide-y tw-divide-slate-100">
                            ...
                            <tr class="hover:tw-bg-slate-50 tw-transition-colors tw-duration-100">
                                <td class="tw-px-6 tw-py-4 tw-text-slate-400 tw-font-mono tw-text-xs">#<?php echo e($role->id); ?></td>
                                <td class="tw-px-6 tw-py-4">
                                    <div class="tw-flex tw-items-center tw-gap-2.5">
                                        ...
                                        <span class="tw-font-medium tw-text-slate-800"><?php echo e($role->name); ?></span>
                                    </div>
                                </td>
                                ...
                                <td class="tw-px-6 tw-py-4 tw-text-center">
                                    <form action="<?php echo e(route('roles.destroy', $role->id)); ?>" method="POST" class="tw-inline">
                                        <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
                                        <button type="submit"
                                                title="Supprimer ce rôle"
                                                onclick="return confirm('Confirmer la suppression du rôle « <?php echo e(addslashes($role->name)); ?> » ?')"
                            ...
                            <tr>
                                <td colspan="4" class="tw-px-6 tw-py-12 tw-text-center">
                                    <div class="tw-flex tw-flex-col tw-items-center tw-gap-3">
                                        ...
                                        <a href="<?php echo e(route('roles.create')); ?>" class="tw-text-[#1D4ED8] tw-text-sm hover:tw-underline tw-no-underline">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ADAM EDJABE\Desktop\cmcuapp\resources\views/admin/roles/index.blade.php ENDPATH**/ ?>