            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card border-0 shadow-sm mb-4">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                <h4><?php echo e($visit->patient_display_name); ?></h4>
                                ...
                                <?php if($visit->patient && $visit->patient->dossiers->first()): ?>
                                <p class="text-muted mb-1">
                ...
                <div class="col-md-8">
                    ...
                    <!-- Informations financières — visible to Admin (1) and Secrétaire (6) only -->
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ADAM EDJABE\Desktop\cmcuapp\resources\views/admin/patient_visits/show.blade.php ENDPATH**/ ?>