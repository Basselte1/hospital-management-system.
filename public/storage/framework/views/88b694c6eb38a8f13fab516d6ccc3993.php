        ...
        <div id="fe-modal-dialog"
            ...
            <div style="overflow-y:auto; flex:1; padding:24px;">
                <form id="formNouvelleFactureExamen"
                      method="POST"
                      action="<?php echo e(route('facturation.examens.store_direct')); ?>">
                    <?php echo csrf_field(); ?>
...
(function () {
    ...
    function initialiserSelect2() {
        ...
        $('#fe-patient-select').select2({
            ...
            ajax: {
                url: '<?php echo e(route("facturation.examens.api.search_patients")); ?>',
                dataType: 'json',
                delay: 300,
    ...
    function chargerPrescriptions(patientId) {
        ...
        fetch('<?php echo e(route("facturation.examens.api.patient_examens")); ?>?patient_id=' + patientId)
...
<?php $__env->stopPush(); ?><?php /**PATH C:\Users\ADAM EDJABE\Desktop\cmcuapp\resources\views/admin/factures/partials/create_facture_examen.blade.php ENDPATH**/ ?>