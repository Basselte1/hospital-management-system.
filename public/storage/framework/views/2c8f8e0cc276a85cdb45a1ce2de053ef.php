...
<?php $__env->startSection('title', 'CMCU | Aperçu Facture Examen — ' . $facture->numero); ?>
...
<div class="wrapper tw-flex tw-h-screen tw-overflow-hidden tw-bg-slate-50">
    ...
    <div class="container py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
            ...
            <a href="<?php echo e(route('facturation.examens.index')); ?>" class="btn btn-secondary">
            ...
            <div class="card-body p-4" style="position: relative; z-index: 1;">
                ...
                <table class="table table-bordered table-hover mb-0">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $lignes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ligne): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td class="text-muted" style="font-size:12px;">
                                    ...
                                    <?php echo e($ligne->technicien ?? $ligne->medecin ?? '—'); ?>
                    ...
                    <tfoot>
                        ...
                        <?php if(($facture->patient->avance ?? 0) > 0): ?>
        ...
        <div class="d-flex justify-content-center gap-3 mt-4 flex-wrap">
            <a href="<?php echo e(route('facturation.examens.index')); ?>" class="btn btn-outline-secondary">
                <i class="fas fa-arrow-left me-1"></i> Retour à la liste
            </a>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ADAM EDJABE\Desktop\cmcuapp\resources\views/admin/factures/partials/apercu_examen.blade.php ENDPATH**/ ?>