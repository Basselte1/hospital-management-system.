                    ...
                    <table class="tw-w-full tw-text-sm">
                        ...
                        <tbody class="tw-divide-y tw-divide-slate-100">
                            ...
                            <tr class="hover:tw-bg-slate-50 tw-transition-colors">
                                ...
                                <td class="tw-px-4 tw-py-3 tw-text-xs tw-text-slate-400 tw-whitespace-nowrap"><?php echo e($imagerie->created_at->toFormattedDateString()); ?></td>
                                <td class="tw-px-4 tw-py-3">
                                    <a href="<?php echo e(route('imageries_examens.pdf', $imagerie->id)); ?>" title="Imprimer"
...
</div><?php /**PATH C:\Users\ADAM EDJABE\Desktop\cmcuapp\resources\views/admin/modal/index_examen_imagerie.blade.php ENDPATH**/ ?>