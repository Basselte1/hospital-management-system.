...
<div id="content">
    <!-- top-bar -->
    <nav class="navbar navbar-light tw-bg-white tw-border-slate-200 tw-shadow-sm mb-xl-5 mb-4">
        <div class="container-fluid position-relative">

            <div class="navbar-header">
                <button type="button" id="sidebarCollapse" class="tw-flex tw-items-center tw-justify-center tw-w-9 tw-h-9 tw-rounded-lg tw-bg-[#1D4ED8] tw-text-white hover:tw-bg-[#1a46c5] tw-transition-colors tw-duration-150 tw-shrink-0 tw-border-0 btn btn-prime navbar-btn float-start" style="background-color: #4463dc;">
    ...
    <div class="tw-relative" id="userDropdownWrapper">
        ...
        <div id="userDropdownMenu"
                ...
                <div class="tw-flex tw-items-center tw-gap-3">
                    <div class="tw-w-11 tw-h-11 tw-rounded-full tw-flex tw-items-center tw-justify-center tw-shrink-0"
                        ...
                        <span class="tw-text-white tw-text-lg tw-font-bold tw-uppercase tw-leading-none">
                            <?php echo e(mb_substr(Auth::user()->name ?? 'U', 0, 1)); ?>
                    ...
                    <div class="tw-min-w-0">
                        ...
                        <p class="tw-text-white/70 tw-text-xs tw-mb-0 tw-mt-0.5 tw-truncate">
                            <?php echo e(Auth::user()->login ?? Auth::user()->email); ?>
            ...
            <div class="tw-py-1">
                <a href="<?php echo e(route('users.profile', Auth::user()->id)); ?>"
            ...
            <div class="tw-border-t tw-border-slate-100 tw-py-1">
                ...
                <form id="topbar-logout-form" action="<?php echo e(route('logout')); ?>" method="POST" class="tw-hidden">
                    <?php echo csrf_field(); ?>
                </form>
            </div>
...
</script><?php /**PATH C:\Users\ADAM EDJABE\Desktop\cmcuapp\resources\views/partials/header.blade.php ENDPATH**/ ?>