    ...
    <div style="display: table; width: 100%;">
        ...
        <div style="display: table-cell; width: 100%; padding: 2%; vertical-align: top;">
            <div class="container">
                ...
                <div class="notices">
                    <h6>LA CAISSE: <?php echo e(($user['user']['prenom'] ?? '') . ' ' . ($user['user']['name'] ?? ' ')); ?></h6>
...
</html><?php /**PATH C:\xampp\htdocs\cmcuapp\resources\views/admin/etats/consultation.blade.php ENDPATH**/ ?>