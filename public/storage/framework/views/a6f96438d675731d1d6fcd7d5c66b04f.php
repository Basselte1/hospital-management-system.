    ...
    <div class="main-content-area">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                ?>
                <div class="col-lg-<?php echo e($showSidebar ? '9' : '12'); ?> col-md-12 mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-wrap justify-content-center gap-2 mb-4">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('med_inf_anes', \App\Models\Patient::class)): ?>
                                    ...
                                    <a class="btn btn-primary" href="<?php echo e(route('fiche.prescription_medicale.index', $patient)); ?>">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\JUSTO TCHEUMANI\DESKTOP\CMCU\Nouveaudossier\Deployfortest\cmcuapp\cmcuapp\resources\views/admin/patients/show.blade.php ENDPATH**/ ?>