...
.rx-header::before {
    ...
    inset: 0;
    background:
        radial-gradient(circle 320px at 90% -20%, rgba(255,255,255,.12) 0%, transparent 65%),
        radial-gradient(circle 200px at 5% 110%, rgba(255,255,255,.08) 0%, transparent 60%);
    pointer-events: none;
}
...
<div id="rxOverlay" class="rx-overlay" aria-hidden="true">
    ...
    <div class="text-white fw-semibold">Génération en cours…</div>
</div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\JUSTO TCHEUMANI\DESKTOP\CMCU\Nouveaudossier\Proj\cmcu\cmcuapp\resources\views/admin/prescriptions/ordonance_create.blade.php ENDPATH**/ ?>