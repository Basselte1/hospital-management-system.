                                ...
                                <div class="tw-grid tw-grid-cols-1 sm:tw-grid-cols-2 tw-gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" class="form-control motif-field" id="details_motif_autres" 
                                               ...
                                               placeholder="Précisez le motif" value="<?php echo e(old('details_motif')); ?>" 
                                               style="display:none;">

                                        <input type="hidden" name="details_motif" id="details_motif_hidden" 
                                        value="<?php echo e(old('details_motif')); ?>">
                                        ...
                                        <div class="tw-bg-slate-50 tw-border tw-border-slate-200 tw-rounded-xl tw-p-4">
                                            ...
                                            <div class="tw-grid tw-grid-cols-1 sm:tw-grid-cols-3 tw-gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <input name="emetteur_cheque" id="emetteur_cheque" class="form-control" value="<?php echo e(old('emetteur_cheque')); ?>" type="text" placeholder="Nom émetteur">
                                                </div>
                                                <div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ADAM EDJABE\Desktop\cmcuapp\resources\views/admin/patient_visits/create.blade.php ENDPATH**/ ?>