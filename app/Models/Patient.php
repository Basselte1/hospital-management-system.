...
class Patient extends Model
{
    ...
    public function facture_examens()
    {
        return $this->hasMany(\App\Models\FactureExamen::class);
    }

    public function facture_actes()
    {
        return $this->hasMany(\App\Models\FactureActe::class);
    }
    ...
    public function examens_laboratoire()
    {
        return $this->hasMany(\App\Models\ExamenLaboratoire::class, 'patient_id');
    }

    /**
     * Get only validated laboratory results.
     */
    public function examens_laboratoire_valides()
    {
        return $this->hasMany(\App\Models\ExamenLaboratoire::class, 'patient_id')
            ->whereIn('statut', ['valide', 'remis'])
            ->latest();
    }
