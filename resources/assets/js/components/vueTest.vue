    ...
    <div class="calendar-main">
      ...
      <div class="status-legend mb-3">
        ...
        <div class="d-flex flex-wrap gap-2">
          <span class="badge" style="background-color: #4682B4; color: white;">À venir</span>
          <span class="badge" style="background-color: #008B8B; color: white;">Vu</span>
          <span class="badge" style="background-color: #DDA0DD; color: black;">Absence excusée</span>
          <span class="badge" style="background-color: #6A5ACD; color: white;">Absence non excusée</span>
          <span class="badge" style="background-color: #FF6347; color: white;">Reporté</span>
        </div>
      </div>
            ...
            <form @submit.prevent="saveEvent">
              <div class="modal-body">
                ...
                <div class="mb-3" v-if="editingEvent">
                  ...
                  <div class="status-radio-group d-flex gap-2 flex-wrap">
...
const adjustHeights = async () => {
  ...
  try {
    ...
    const baseMin = 700
    const increasedMin = Math.round(baseMin * 1.25)
