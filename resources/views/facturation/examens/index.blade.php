...
@section('title', 'Facturation - Examens')
...
<div class="container-fluid">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <a href="{{ route('facturation.examens.index') }}" class="btn btn-secondary">Reset</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('facturation.examens.show', $facture) }}" class="btn btn-sm btn-info">Voir</a>
                                <a href="{{ route('facturation.examens.print', $facture) }}" class="btn btn-sm btn-success">Imprimer</a>
                            </td>
                        </tr>
                        @empty
                        <tr>
    ...
    <div class="text-end mt-3">
        <a href="{{ route('facturation.examens.create') }}" class="btn btn-success">
