...
<html lang="fr">
<head>
    <title>@yield('title', 'CMCU') · {{ app_version('label') }}</title>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="{{ asset('vendor/css/select2.min.css') }}" media="print" onload="this.media='all'">
...
<script src="{{ asset('vendor/js/select2.min.js') }}" defer></script>
<script src="{{ asset('vendor/js/sweetalert2.all.min.js') }}" defer></script>
