            ...
            <div class="tw-max-w-screen-2xl tw-mx-auto">
                ...
                <div class="tw-grid tw-grid-cols-2 lg:tw-grid-cols-4 tw-gap-4 tw-mb-8">
                    ...
                    <div class="tw-bg-white tw-rounded-2xl tw-p-5 tw-shadow-card tw-border tw-border-slate-100 tw-flex tw-items-center tw-gap-4">
                        ...
                        <div>
                            ...
                            <p class="tw-text-2xl tw-font-bold tw-text-slate-800 tw-leading-none">{{ $devis->where('statut', 'brouillon')->count() }}</p>
                        </div>
                    </div>
                    ...
                    <div class="tw-bg-white tw-rounded-2xl tw-p-5 tw-shadow-card tw-border tw-border-amber-100 tw-flex tw-items-center tw-gap-4">
                        ...
                        <div>
                            ...
                            <p class="tw-text-2xl tw-font-bold tw-text-slate-800 tw-leading-none">{{ $devis->where('statut', 'en_attente')->count() }}</p>
                        </div>
                    </div>
                    ...
                    <div class="tw-bg-white tw-rounded-2xl tw-p-5 tw-shadow-card tw-border tw-border-emerald-100 tw-flex tw-items-center tw-gap-4">
                        ...
                        <div>
                            ...
                            <p class="tw-text-2xl tw-font-bold tw-text-slate-800 tw-leading-none">{{ $devis->where('statut', 'valide')->count() }}</p>
                        </div>
                    </div>
                    ...
                    <div class="tw-bg-white tw-rounded-2xl tw-p-5 tw-shadow-card tw-border tw-border-red-100 tw-flex tw-items-center tw-gap-4">
                        ...
                        <div>
                            ...
                            <p class="tw-text-2xl tw-font-bold tw-text-slate-800 tw-leading-none">{{ $devis->where('statut', 'refuse')->count() }}</p>
                        </div>
                    </div>
                ...
                <div class="tw-bg-white tw-rounded-2xl tw-shadow-card tw-border tw-border-slate-100 tw-overflow-hidden">
                    ...
                    <div class="tw-px-6 tw-py-4 tw-border-b tw-border-slate-100 tw-flex tw-items-center tw-justify-between">
                        ...
                        <span class="tw-text-xs tw-text-slate-400">{{ $devis->count() }} résultat(s)</span>
                    </div>
                            ...
                            <tbody class="tw-divide-y tw-divide-slate-100">
                                ...
                                <tr class="hover:tw-bg-slate-50/70 tw-transition-colors tw-duration-100">
                                    ...
                                    <td class="tw-px-5 tw-py-3.5 tw-whitespace-nowrap">
                                        <span class="tw-font-mono tw-font-semibold tw-text-primary-700 tw-text-xs tw-bg-primary-50 tw-px-2 tw-py-1 tw-rounded-lg">{{ $devi->code }}</span>
                                    </td>

                                    {{-- Patient --}}
                                    <td class="tw-px-5 tw-py-3.5">
                                        @if($devi->patient)
                                            <span class="tw-text-slate-800 tw-font-medium">{{ $devi->patient->name }} {{ $devi->patient->prenom }}</span>
                                        @else
                                    ...
                                    <td class="tw-px-5 tw-py-3.5">
                                        @if($devi->medecin)
                                            <span class="tw-text-slate-700">Dr. {{ $devi->medecin->name }}</span>
                                    ...
                                    <td class="tw-px-5 tw-py-3.5 tw-text-right tw-whitespace-nowrap">
                                        <span class="tw-font-semibold tw-text-slate-800">{{ number_format($devi->montant_apres_reduction, 0, ',', ' ') }}&nbsp;FCFA</span>
                                        @if($devi->pourcentage_reduction > 0)
                                            <br>
                                            <span class="tw-text-xs tw-text-slate-400 tw-line-through">{{ number_format($devi->montant_avant_reduction, 0, ',', ' ') }}&nbsp;FCFA</span>
                                        @endif
                                    </td>
                                    ...
                                    {{-- Date --}}
                                    <td class="tw-px-5 tw-py-3.5 tw-whitespace-nowrap">
                                        <span class="tw-text-xs tw-text-slate-500">{{ $devi->created_at->format('d/m/Y') }}</span>
                                    </td>
                                    ...
                                    <td class="tw-px-5 tw-py-3.5">
                                        <div class="tw-flex tw-items-center tw-justify-center tw-gap-1 tw-flex-wrap">
                                            ...
                                            @can('update', \App\Models\Devi::class)
                                                ...
                                                @if($devi->statut == 'brouillon')
                                                    <button type="button"
                                                            ...
                                                            data-action="{{ route('devis.envoyer_validation', $devi->id) }}"
                                                            data-method="POST"
                                                ...
                                                @if($devi->statut == 'en_attente' && $devi->user_id == Auth::id())
                                                    <button type="button"
                                                            ...
                                                            data-action="{{ route('devis.annuler_envoi', $devi->id) }}"
                                                            data-method="POST"
                                                ...
                                                @if($devi->statut == 'refuse' && $devi->user_id == Auth::id())
                                                    <button type="button"
                                                            ...
                                                            data-action="{{ route('devis.annuler_refus', $devi->id) }}"
                                                            data-method="POST"
                                            ...
                                            @if($devi->statut == 'valide' && (
                                                ...
                                                <button type="button"
                                                        class="tw-w-8 tw-h-8 tw-rounded-lg tw-border tw-border-amber-200 tw-bg-amber-50 hover:tw-bg-amber-100 tw-text-amber-700 tw-flex tw-items-center tw-justify-center tw-transition-colors tw-duration-150 action-btn"
                                                        data-action="{{ route('devis.annuler_validation', $devi->id) }}"
                                                        data-method="POST"
                                            ...
                                            {{-- Doctor actions: reduce / validate / refuse --}}
                                            @can('valider', \App\Models\Devi::class)
                                            ...
                                            @can('print', \App\Models\Devi::class)
                                                @if($devi->statut == 'valide')
                                                    <a href="{{ route('devis.print', $devi->id) }}"
                                            ...
                                            @can('delete', \App\Models\Devi::class)
                                                @if($devi->statut == 'brouillon' || $devi->statut == 'refuse')
                                                    <button type="button"
                                                            ...
                                                            data-action="{{ route('devis.destroy', $devi->id) }}"
                                                            data-method="DELETE"
