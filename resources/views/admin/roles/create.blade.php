    ...
    <div id="content" class="tw-flex tw-flex-col tw-flex-1 tw-min-w-0 tw-overflow-y-auto">
        ...
        <main class="tw-flex-1 tw-p-4 sm:tw-p-6 lg:tw-p-8">
            ...
            <nav class="tw-flex tw-items-center tw-gap-2 tw-text-sm tw-text-slate-500 tw-mb-6">
                ...
                <span class="tw-text-slate-700 tw-font-medium">Nouveau rôle</span>
            </nav>
            ...
            <div class="tw-max-w-xl">
                <div class="tw-bg-white tw-rounded-2xl tw-shadow-sm tw-border tw-border-slate-100 tw-overflow-hidden">
                    ...
                    <div class="tw-px-6 tw-py-5 tw-border-b tw-border-slate-100 tw-flex tw-items-center tw-gap-3">
                        <div class="tw-w-9 tw-h-9 tw-rounded-xl tw-bg-[#BFDBFE] tw-flex tw-items-center tw-justify-center tw-shrink-0">
                            <i class="fas fa-user-shield tw-text-[#1D4ED8] tw-text-sm"></i>
                        </div>
                        <div>
                            <h1 class="tw-text-base tw-font-bold tw-text-slate-800 tw-mb-0">Ajouter un nouveau rôle</h1>
                            <p class="tw-text-xs tw-text-slate-400 tw-mb-0 tw-mt-0.5">Remplissez le formulaire ci-dessous</p>
                        </div>
                    </div>

                    {{-- Form body --}}
                    <form action="{{ route('roles.store') }}" method="POST" class="tw-p-6">
                        @csrf

                        {{-- Info notice --}}
                        <div class="tw-flex tw-items-start tw-gap-2.5 tw-bg-[#eff6ff] tw-border tw-border-[#BFDBFE] tw-rounded-xl tw-px-4 tw-py-3 tw-mb-6">
                        ...
                        <div class="tw-mb-6">
                            ...
                            <input
                                ...
                                name="name"
                                value="{{ old('name') }}"
                                placeholder="Ex: Administrateur, Médecin, Infirmier..."
                                required
