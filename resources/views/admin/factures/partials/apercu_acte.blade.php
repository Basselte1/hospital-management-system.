{{--
    ============================================================
    FICHIER : resources/views/admin/factures/partials/apercu_acte.blade.php

--}}

@extends('layouts.admin')

@section('title', 'CMCU | Aperçu Facture Acte — ' . $facture->numero)
...
<div class="wrapper tw-flex tw-h-screen tw-overflow-hidden tw-bg-slate-50">
    ...
    <div class="container py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
            ...
            <a href="{{ route('facturation.actes.index') }}" class="btn btn-secondary">
        ...
        <div class="d-flex justify-content-center gap-3 mt-4 flex-wrap">
            ...
            <a href="{{ route('facturation.actes.index') }}" class="btn btn-outline-secondary">
                <i class="fas fa-arrow-left me-1"></i> Retour à la liste
            </a>
