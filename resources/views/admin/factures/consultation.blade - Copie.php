                                ...
                                <tr class="{{ $facture->isSoldee() ? 'table-success' : '' }}">
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            ...
                                            @can('update', $facture)
                                                {{-- Bouton EDIT : grisé si soldée (comportement inchangé) --}}
                                                ...
                                                {{-- ⚠️ TEMPORAIRE : DELETE actif pour toutes les factures --}}
                                                {{-- TODO : remettre @if($facture->isModifiable()) après nettoyage --}}
