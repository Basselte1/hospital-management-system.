                        ...
                        <table class="tw-w-full tw-text-sm">
                            ...
                            <tbody class="tw-divide-y tw-divide-slate-100">
                                ...
                                <tr class="hover:tw-bg-slate-50 tw-transition-colors">
                                    <td class="tw-px-4 tw-py-3 tw-font-medium tw-text-slate-700">{{ $premedication->medicament }}</td>
                                    <td class="tw-px-4 tw-py-3 tw-text-slate-600">{{ $premedication->consigne_ide }}</td>
                                    <td class="tw-px-4 tw-py-3 tw-text-slate-600">{{ $premedication->preparation }}</td>
                                    <td class="tw-px-4 tw-py-3 tw-text-xs tw-text-slate-400">{{ $premedication->created_at }}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
