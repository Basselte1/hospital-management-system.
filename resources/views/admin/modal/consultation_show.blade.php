                    ...
                    <table class="tw-w-full tw-text-sm">
                        ...
                        <tbody class="tw-divide-y tw-divide-slate-100">
                            ...
                            <tr class="hover:tw-bg-slate-50 tw-transition-colors">
                                <td class="tw-px-4 tw-py-3 tw-font-medium tw-text-slate-700">{{ $consultation->diagnostic }}</td>
                                <td class="tw-px-4 tw-py-3 tw-text-slate-500 tw-text-xs">{{ $consultation->created_at->toFormattedDateString() }}</td>
                                <td class="tw-px-4 tw-py-3">
                                    <a href="{{ route('consultations.show', $consultation->id) }}" title="Plus de détails"
