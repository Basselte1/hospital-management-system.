{{-- index_examen_biologie.blade.php --}}
                    ...
                    <table class="tw-w-full tw-text-sm">
                        ...
                        <tbody class="tw-divide-y tw-divide-slate-100">
                            ...
                            <tr class="hover:tw-bg-slate-50 tw-transition-colors">
                                ...
                                <td class="tw-px-4 tw-py-3 tw-text-xs tw-text-slate-400 tw-whitespace-nowrap">{{ $prescription->created_at->toFormattedDateString() }}</td>
                                <td class="tw-px-4 tw-py-3">
                                    <a href="{{ route('prescription_examens.pdf', $prescription->id) }}" title="Imprimer"
