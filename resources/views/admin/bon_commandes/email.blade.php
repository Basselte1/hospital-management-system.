...
<body>
    ...
    <div class="content">
        <h2 style="color: #0066cc;">Bon de Commande N° {{ $bonCommande->numero_bon }}</h2>
        
        <p>Bonjour,</p>
        
        <p>Nous vous adressons notre bon de commande <strong>{{ $bonCommande->numero_bon }}</strong>.</p>
        ...
        <div class="info-box">
            ...
            <div class="info-row">
                ...
                {{ $bonCommande->date_livraison_souhaitee->format('d/m/Y') }}
            </div>
            @endif
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align: right;">{{ number_format($item->montant_ligne, 0, ',', ' ') }} FCFA</td>
                </tr>
                @endforeach
                <tr class="total-row">
                    <td colspan="2" style="text-align: right;">TOTAL:</td>
                    <td style="text-align: right;">{{ number_format($bonCommande->montant_total, 0, ',', ' ') }} FCFA</td>
                </tr>
            </tbody>
        </table>
        ...
        <div style="margin: 30px 0;">
            ...
            <p style="margin: 5px 0; font-weight: bold;">{{ $bonCommande->createdBy->name ?? 'Service Logistique' }}</p>
