...
<div class="tw-container tw-mx-auto tw-px-4 tw-py-8 tw-max-w-4xl">
    ...
    <!-- Bouton retour -->
    <div class="tw-mb-8">
        <a href="{{ route('clients.index') }}" class="tw-inline-flex tw-items-center tw-px-4 tw-py-2 tw-bg-green-600 tw-hover:bg-green-700 tw-text-white tw-font-medium tw-rounded-xl tw-shadow-soft tw-transition-all tw-text-sm" title="Retour à la liste des clients">
    ...
    <div class="tw-text-center tw-mb-12">
        <h1 class="tw-text-4xl tw-md:text-5xl tw-font-bold tw-text-gray-900 tw-mb-4">AJOUTER UN CLIENT</h1>
