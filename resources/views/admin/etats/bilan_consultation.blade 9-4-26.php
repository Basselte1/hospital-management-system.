...
<head>
    ...
    <style>
        * {
        ...
        .main-table th,
        .main-table td {
            border: 1px solid #b0b0b0 ;    /* #dee2e6;*/
            padding: 10px 6px;
            text-align: left;
            vertical-align: middle;
        }
        ...
        .col-patient { width: 18%; color: #2c3e50; font-weight: 500; }
        .col-montant, .col-avance, .col-reste, 
        .col-part-patient, .col-part-ass { width: 9%; text-align: right; font-weight: 600; color: #27ae60; }
        .col-demarcheur { width: 12%; font-size: 8px; color: #7f8c8d; }
        .col-medecin { width: 12%; font-size: 8px; color: #7f8c8d; font-weight: 500; }
        ...
        tr {
            page-break-inside: avoid; /* évite couper une ligne */
        }
        ...
        .signatures-container {
            margin-top: 40px;
            display: table;
            /* display: flex;              Flexbox au lieu de table */
            /*justify-content: center;     Centrer horizontalement */
            /*align-items: flex-start;     Alignement vertical */
            /*gap: 40px;                   Espacement entre les blocs */
             /*flex-wrap: wrap;            Permet de s’adapter si l’espace est réduit */
            /*width: 100%;*/
...
<body>
    ...
    <div class="document-title">
        Fiche de Suivi des Encaissements Journaliers - {{ $service }}
    </div>
