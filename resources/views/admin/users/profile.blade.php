            ...
            <div class="tw-max-w-2xl">
                    ...
                    <div class="tw-px-6 tw-pb-6">
                        <div class="-tw-mt-10 tw-mb-4">
                            <div class="tw-w-20 tw-h-20 tw-rounded-full tw-bg-[#1D4ED8] tw-flex tw-items-center tw-justify-center tw-ring-4 tw-ring-white">
                                <span class="tw-text-white tw-text-3xl tw-font-bold tw-uppercase">{{ mb_substr($user->name, 0, 1) }}</span>
                            </div>
                        </div>
                        <div class="tw-flex tw-items-center tw-gap-3">
                            <div>
                                <h2 class="tw-text-xl tw-font-bold tw-text-slate-800 tw-mb-0">{{ $user->name }} {{ $user->prenom }}</h2>
                                <span class="tw-inline-flex tw-rounded-full tw-px-2.5 tw-py-0.5 tw-text-xs tw-font-medium tw-bg-[#BFDBFE] tw-text-[#1D4ED8] tw-mt-1">{{ $user->role->name }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="tw-p-6 tw-grid tw-grid-cols-1 sm:tw-grid-cols-2 tw-gap-4">
                        ...
                        <div class="tw-flex tw-items-start tw-gap-3">
                            ...
                            <div>
                                ...
                                <p class="tw-text-sm tw-font-semibold tw-text-slate-700 tw-mb-0">{{ $user->name }} {{ $user->prenom }}</p>
                            </div>
                        </div>
                        ...
                        <div class="tw-flex tw-items-start tw-gap-3">
                            ...
                            <div>
                                ...
                                <p class="tw-text-sm tw-font-mono tw-font-semibold tw-text-slate-700 tw-mb-0">{{ $user->login }}</p>
                            </div>
                        </div>
                        ...
                        <div class="tw-flex tw-items-start tw-gap-3">
                            ...
                            <div>
                                ...
                                <p class="tw-text-sm tw-font-semibold tw-text-slate-700 tw-mb-0">{{ $user->sexe }}</p>
                            </div>
                        </div>
                        ...
                        <div class="tw-flex tw-items-start tw-gap-3">
                            ...
                            <div>
                                ...
                                <p class="tw-text-sm tw-font-semibold tw-text-slate-700 tw-mb-0">{{ $user->telephone }}</p>
                            </div>
                        </div>
                        ...
                        <div class="tw-flex tw-items-start tw-gap-3">
                            ...
                            <div>
                                ...
                                <p class="tw-text-sm tw-font-semibold tw-text-slate-700 tw-mb-0">{{ $user->date_naissance }}</p>
                            </div>
                        </div>
                        ...
                        <div class="tw-flex tw-items-start tw-gap-3">
                            ...
                            <div>
                                ...
                                <p class="tw-text-sm tw-font-semibold tw-text-slate-700 tw-mb-0">{{ $user->lieu_naissance }}</p>
                            </div>
                        </div>
                ...
                <div class="tw-bg-white tw-rounded-2xl tw-shadow-sm tw-border tw-border-slate-100">
                    ...
                    <div class="collapse" id="form_mdp">
                        <div class="tw-p-6">
                            <form action="{{ route('users.changePassword', $user->id) }}" method="POST" class="tw-space-y-4">
                                @method('PATCH')
                                @csrf
