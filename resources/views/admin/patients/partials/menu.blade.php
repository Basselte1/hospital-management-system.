    ...
    <div class="tw-flex tw-flex-wrap tw-items-center tw-gap-2">
        ...
        <div class="tw-relative tw-inline-block" x-data="{ open: false }">
            ...
            <ul class="dropdown-menu tw-rounded-xl tw-border-0 tw-shadow-xl tw-p-2 tw-min-w-56">
                <li>
                    <a href="{{ route('premedication_adaptation.index', $patient->id) }}"
                ...
                <li>
                    <a href="{{ route('observations_medicales.index', $patient->id) }}"
                       class="tw-flex tw-items-center tw-gap-2.5 tw-rounded-lg tw-px-3 tw-py-2.5 tw-text-sm tw-text-slate-700 hover:tw-bg-[#BFDBFE]/40 hover:tw-text-[#1D4ED8] tw-no-underline tw-transition-colors">
                        <i class="far fa-plus-square tw-text-xs tw-text-[#1D4ED8] tw-w-4 tw-shrink-0"></i> Observations Médicales
                    </a>
                </li>
                <li>
                    <a href="{{ route('surveillance_score.index', $patient->id) }}"
                       class="tw-flex tw-items-center tw-gap-2.5 tw-rounded-lg tw-px-3 tw-py-2.5 tw-text-sm tw-text-slate-700 hover:tw-bg-[#BFDBFE]/40 hover:tw-text-[#1D4ED8] tw-no-underline tw-transition-colors">
        ...
        <a href="{{ route('fiche_consommable.index', $patient->id) }}"
...
@can('chirurgien', \App\Models\Patient::class)
    ...
    <div class="tw-flex tw-flex-wrap tw-items-center tw-gap-2">
        ...
        {{-- Standalone buttons --}}
        <a href="{{ route('ordonance.create', $patient->id) }}"
        ...
        {{-- Commented items preserved as comments --}}
        {{-- <a href="{{ route('fiche_consommable.index', $patient->id) }}" ...>FICHES DE CONSOMMABLES</a> --}}
    </div>
    @endcannot
@endcan
