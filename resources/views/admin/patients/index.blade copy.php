            ...
            <div class="row mb-4">
                <div class="col-lg-12">
                    <div class="search-card">
                        <form action="{{ route('search.results') }}" method="post" class="row g-3">
                            @csrf
                            <div class="col-md-8">
                    ...
                    <div class="text-center mt-4 mb-4">
                        <a 
                            ...
                            class="btn btn-success btn-lg btn-add-patient" 
                ...
                <div class="col-lg-12">
                    <div class="results-info mb-3">
                        <p class="mb-0">
                            ...
                            Résultats de votre recherche sur <strong class="text-primary">"{{ $name }}"</strong>
                        </p>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table id="myTable" class="table table-striped table-bordered table-hover" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <span class="badge-numero"> {{ $patient->numero_dossier }}</span>
                                            @if($patient->isNew())
                                        ...
                                        <td>
                                            @if($patient->prise_en_charge)
                                                <span class="badge bg-info">{{ $patient->prise_en_charge }}</span>
                                            @else
                                        ...
                                        <td class="text-center">
                                            <div class="btn-action-group">
                                                ...
                                                <a 
                                                    ...
                                                    href="{{ route('consultation.pdf', $patient->id) }}" 
