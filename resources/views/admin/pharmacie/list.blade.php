...
@section('title', 'CMCU | Liste des Ventes')
@section('breadcrumb', 'Pharmacie / Liste des Ventes')
    ...
    <div id="content" class="tw-flex tw-flex-col tw-flex-1 tw-min-w-0 tw-overflow-y-auto">
        ...
        <main class="tw-flex-1 tw-p-4 sm:tw-p-6 lg:tw-p-8">
            ...
            <div class="tw-bg-white tw-rounded-2xl tw-shadow-sm tw-border tw-border-slate-100 tw-mb-6">
                ...
                <div class="tw-p-6">
                    <form method="GET" action="{{ route('pharmacie.sales.list') }}">
                    ...
                    <table class="tw-w-full tw-text-sm">
                        ...
                        <tbody class="tw-divide-y tw-divide-slate-100">
                            ...
                            <tr class="hover:tw-bg-slate-50 tw-transition-colors">
                                ...
                                <td class="tw-px-4 tw-py-3 tw-text-slate-500">{{ $vente->pharmacien->name ?? 'N/A' }}</td>
                                ...
                                <td class="tw-px-4 tw-py-3 tw-text-center">
                                    <div class="tw-flex tw-items-center tw-justify-center tw-gap-1.5">
                                        ...
                                        <a href="{{ route('pharmacie.sales.invoice', $vente->id) }}"
