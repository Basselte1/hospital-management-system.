...
@section('title', 'CMCU | Créer Ordonnance')
@section('content')

{{-- Minimal styles only for the autocomplete dropdown (not coverable by tw- prefix) --}}
<style>
    ...
    <div id="content" class="tw-flex tw-flex-col tw-flex-1 tw-min-w-0 tw-overflow-y-auto">
        ...
        <main class="tw-flex-1 tw-p-4 sm:tw-p-6 lg:tw-p-8">
            ...
            <div class="tw-bg-white tw-rounded-2xl tw-shadow-card tw-border tw-border-slate-100 tw-overflow-hidden">
                ...
                {{-- Form --}}
                <div class="tw-p-5">
                    <form method="POST" id="prescriptionForm" action="{{ route('ordonances.store') }}" novalidate>
                        @csrf
